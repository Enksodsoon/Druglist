...
<head>
    ...
    <title>DailyMed - Search Results for Yaz</title>
            ...
            <div class="resultsNav">
                <div class="filter-drop">
                    <div class="select">
                        ...
                        <input type="hidden" name="query" value="Yaz">
        ...
        <div class="results">
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="065f33e4-b587-4e66-b896-ca9ab7b7c876-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="065f33e4-b587-4e66-b896-ca9ab7b7c876-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="0ed216ab-0c5e-4e77-8170-114a2c530ae7-06.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=065f33e4-b587-4e66-b896-ca9ab7b7c876">YAZ (drospirenone and ethinyl estradiol) kit<br></a>
                ...
                <article class="row even">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="077bf6ff-afb8-4cb7-9faa-fbb6fd9f037f-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="077bf6ff-afb8-4cb7-9faa-fbb6fd9f037f-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="5828.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=077bf6ff-afb8-4cb7-9faa-fbb6fd9f037f">YAZ (drospirenone and ethinyl estradiol) kit<br></a>
                        ...
                        <ul class="drug-information">
                            ...
                            <li>
                                ...
                                <span id="item-code-sndc">
                                        ...
                                        <a href="/dailymed/search.cfm?searchdb=ndc&query=50419-405">50419-405</a>
