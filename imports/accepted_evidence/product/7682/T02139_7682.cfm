...
<head>
    ...
    <title>DailyMed - Search Results for Cloxacillin /</title>
            ...
            <div class="resultsNav">
                <div class="filter-drop">
                    <div class="select">
                        ...
                        <input type="hidden" name="query" value="Cloxacillin /">
        ...
        <div class="results">
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="6fbf05bc-2be7-4a26-9ed4-107b4b4d8a5b-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="6fbf05bc-2be7-4a26-9ed4-107b4b4d8a5b-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <h2 class="drug-name long-title">
                                ...
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=6fbf05bc-2be7-4a26-9ed4-107b4b4d8a5b">DRY-CLOX (cloxacillin benzathine) gel<br></a>
                        ...
                        <ul class="drug-information">
                            ...
                            <li><strong>Packager:</strong> <span>Boehringer Ingelheim Animal Health USA Inc.</span></li>
                ...
                <article class="row even">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="0fc4b59b-30b4-480f-bad9-460e30209a35-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="0fc4b59b-30b4-480f-bad9-460e30209a35-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="orbenin-02.jpg|orbenin-03.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=0fc4b59b-30b4-480f-bad9-460e30209a35">ORBENIN-DC (cloxacillin benzathine) suspension<br></a>
