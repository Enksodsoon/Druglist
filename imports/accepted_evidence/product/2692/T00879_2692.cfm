...
<head>
    ...
    <title>DailyMed - Search Results for Cefditoren</title>
            ...
            <div class="resultsNav">
                <div class="filter-drop">
                    <div class="select">
                        ...
                        <input type="hidden" name="query" value="Cefditoren">
        ...
        <div class="results">
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="d5050d0e-81d1-4707-a38a-e80de2aebf09-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="d5050d0e-81d1-4707-a38a-e80de2aebf09-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="cefditoren 200mglabel 20pack.jpg|cefditoren 400mg label 20pack.jpg|cefditoren 400mg label 28pack.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=d5050d0e-81d1-4707-a38a-e80de2aebf09">CEFDITOREN PIVOXIL tablet, film coated<br></a>
                        ...
                        <ul class="drug-information">
                            ...
                            <li><strong>Packager:</strong> <span>Pharma RomLev Inc.</span></li>
                ...
                <article class="row even">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="1c90b649-5536-417c-82cb-89663137f14f-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="1c90b649-5536-417c-82cb-89663137f14f-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="spectracef 200mg label.jpg|spectracef 400mg label 20pack.jpg|spectracef 400mg label 28pack.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=1c90b649-5536-417c-82cb-89663137f14f">SPECTRACEF (cefditoren pivoxil) tablet, film coated<br>SPECTRACEF (cefditoren pivoxil) tablet, film coated<br></a>
                        ...
                        <ul class="drug-information">
                            ...
                            <li><strong>Packager:</strong> <span>Vansen Pharma Inc.</span></li>
