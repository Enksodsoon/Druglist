...
<head>
    ...
    <title>DailyMed - Search Results for Hydrochlorothiazide + Amiloride</title>
            ...
            <div class="resultsNav">
                <div class="filter-drop">
                    <div class="select">
                        ...
                        <input type="hidden" name="query" value="Hydrochlorothiazide + Amiloride">
    ...
    <div class="pagination-links">
        ...
        <div class="results">
                ...
                <article class="row even">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="71f5c703-94d4-49b0-9c2d-374b9cbcab85-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="71f5c703-94d4-49b0-9c2d-374b9cbcab85-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <h2 class="drug-name long-title">
                                ...
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=71f5c703-94d4-49b0-9c2d-374b9cbcab85">AMILORIDE HYDROCHLORIDE AND HYDROCHLOROTHIAZIDE tablet<br></a>
                        ...
                        <ul class="drug-information">
                            ...
                            <li>
                                ...
                                <span id="item-code-sndc">
                                        ...
                                        <a href="/dailymed/search.cfm?searchdb=ndc&query=0378-0577">0378-0577</a>
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="3f91cd92-eb6d-4bda-9cad-2e11e0b0fbe2-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="3f91cd92-eb6d-4bda-9cad-2e11e0b0fbe2-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="5USPIL-GUNA-DIUR-rev05-10-18.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=3f91cd92-eb6d-4bda-9cad-2e11e0b0fbe2">GUNA-DIUR (amiloride - apis mellifera - berberis vulgaris fruit - hieracium pilosella flowering top - hydrochlorothiazide - solidago virgaurea flowering top - spironolactone - sus scrofa pituitary gland -) solution/ drops<br></a>
