    ...
    <div class="pagination-links">
        <form action="/dailymed/search.cfm" method="GET">
            ...
            <!-- If there is more pages, show a link, otherwise show disabled text -->
                ...
                <a class="next-link" href="/dailymed/search.cfm?query=Cimetidine&amp;page=2&amp;pagesize=20">next &gt;</a>
        ...
        <div class="results">
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="0ab5ea2b-bd2f-49ec-9e92-033bed998797-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="0ab5ea2b-bd2f-49ec-9e92-033bed998797-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="lbl636291783.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=0ab5ea2b-bd2f-49ec-9e92-033bed998797">CIMETIDINE tablet, film coated<br></a>
