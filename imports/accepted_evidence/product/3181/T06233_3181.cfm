...
<head>
    ...
    <title>DailyMed - Search Results for Neomycin Sulfate +Polymyxin B Sulfate +Gramicidin /</title>
            ...
            <div class="resultsNav">
                <div class="filter-drop">
                    <div class="select">
                        ...
                        <input type="hidden" name="query" value="Neomycin Sulfate +Polymyxin B Sulfate +Gramicidin /">
        ...
        <div class="results">
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="e6f8d2f6-adff-4ae1-982c-45562f0a8e28-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="e6f8d2f6-adff-4ae1-982c-45562f0a8e28-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="Carton.JPG.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=e6f8d2f6-adff-4ae1-982c-45562f0a8e28">NEOMYCIN AND POLYMYXIN B SULFATES AND GRAMICIDIN (neomycin sulfate, polymyxin b sulfate and gramicidin) solution/ drops<br></a>
                ...
                <article class="row even">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="9691178e-5323-40ce-a8b3-f79e88f02797-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="9691178e-5323-40ce-a8b3-f79e88f02797-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="lbl500900247.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=9691178e-5323-40ce-a8b3-f79e88f02797">NEOMYCIN AND POLYMYXIN B SULFATES AND GRAMICIDIN (neomycin sulfate, polymyxin b sulfate and gramicidin) solution/ drops<br></a>
                        ...
                        <ul class="drug-information">
                            ...
                            <li>
                                ...
                                <span id="item-code-sndc">
                                        ...
                                        <a href="/dailymed/search.cfm?searchdb=ndc&query=24208-790">24208-790</a>
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="94e3b620-f9b2-4c8b-9ee8-8b27207a2cab-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="94e3b620-f9b2-4c8b-9ee8-8b27207a2cab-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="NDC 55045-1194-02 ------ BAUSCH and  LOMB.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=94e3b620-f9b2-4c8b-9ee8-8b27207a2cab">NEOMYCIN AND POLYMYXIN B SULFATES AND GRAMICIDIN (neomycin sulfate, polymyxin b sulfate and gramicidin) solution/ drops<br></a>
                ...
                <article class="row even">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="e2d2199c-3b8a-4071-9c01-d1e8879f9bff-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="e2d2199c-3b8a-4071-9c01-d1e8879f9bff-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="6253.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=e2d2199c-3b8a-4071-9c01-d1e8879f9bff">NEOMYCIN AND POLYMYXIN B SULFATES AND GRAMICIDIN (neomycin sulfate, polymyxin b sulfate and gramicidin) solution/ drops<br></a>
                ...
                <article class="row odd">
                    ...
                    <div class="results-thumbs">
                        <!-- Package photos -->
                        <div class="col" id="65edc059-0806-4625-b583-0e36f04cf085-labels">
                            <ul class="first-thumbnail">
                                <li class="img package-photo">
                                    <!-- Place the loading image -->
                                    <img alt="loading image" style="width:35%;" id="65edc059-0806-4625-b583-0e36f04cf085-loading-spl" src="/public/dailymed-cf/images/gif-load.4fa4ef190eb4.gif" />
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="results-info"
                        ...
                        data-dmpkgphoto-files="65edc059-0806-4625-b583-0e36f04cf085-01.jpg"
                    
                    >

                        <h2 class="drug-name long-title">
                            
                                <a class="drug-info-link" href="/dailymed/drugInfo.cfm?setid=65edc059-0806-4625-b583-0e36f04cf085">NEOMYCIN AND POLYMYXIN B SULFATES AND GRAMICIDIN (neomycin sulfate, polymyxin b sulfate and gramicidin) solution/ drops<br></a>
